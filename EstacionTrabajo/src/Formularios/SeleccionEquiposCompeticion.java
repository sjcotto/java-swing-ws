...
/*
 * SeleccionEquiposCompeticion.java
 *
...
public class SeleccionEquiposCompeticion extends javax.swing.JInternalFrame {

    /** Creates new form SeleccionEquiposCompeticion */
    public SeleccionEquiposCompeticion(Tarea1 parent,TipoCompeticion tipo, IControladorCompeticiones icc) { // GONZALO
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton13.setText("Agregar Equipo");
        ...
        jLabel1.setText("Selecciones un equipo y presione, 'Agregar Equipo'");
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        ...
        this.listaEquiposSeleccionados.add(d);
...
//
        ...
        try{
            icCompeticiones.seleccionarEquipo(idSeleccionadoTabla); /// GONZALO
        }catch(Exception e){
        
        }
            //mensaje de error al ingresar el equipo
        jButton13.setEnabled(false);
...
//        IControladorCompeticiones icc = f.getIControladorCompeticiones();
        try {
            ...
            if (!ok){
                ...
                if ( tipoC == tipoC.Copa){
                    JInternalFrame j = new IngresarDividendos(this.listaEquiposSeleccionados,parent,tipoC,icCompeticiones);
                    parent.getLayeredPane().add(j);
                    j.setVisible(true);
                }else if (tipoC == tipoC.Liga){
                    JInternalFrame j = new IngresarTipoCriterioLiga(this.listaEquiposSeleccionados,parent,tipoC,icCompeticiones);
                    parent.getLayeredPane().add(j);
                    j.setVisible(true);
                    this.dispose();
                }
                    ...
                    JInternalFrame j = new confirmarCompeticion(parent,icCompeticiones);
                    parent.getLayeredPane().add(j);
                    j.setVisible(true);
                    this.dispose();
                }
