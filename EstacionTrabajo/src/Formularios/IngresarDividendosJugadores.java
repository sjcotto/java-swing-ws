...
public class IngresarDividendosJugadores extends javax.swing.JInternalFrame {

    /** Creates new form IngresarDividendos */
    public IngresarDividendosJugadores(List<DataIdNombre> l, Tarea1 parent,TipoCompeticion tC, IControladorCompeticiones icc) { // GONZALO
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel27.setFont(new java.awt.Font("DejaVu Sans", 1, 13));
        ...
        jLabel22.setText("nombre del jugadoooooooooooooooooo");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jLabel22, javax.swing.GroupLayout.PREFERRED_SIZE, 286, Short.MAX_VALUE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
...
//        IControladorCompeticiones icc = f.getIControladorCompeticiones();
        ...
        try{
            ...
            try{
                icCompeticiones.agregarIJC(id, div); // GONZALO
            ...
            if (!error){
                if (lista.size() > 0){
                   ...
                   //estamos en el caso de que se termina se ingresar dividendos y no hubo errores
                        ...
                        JInternalFrame j = new IngresarMontoPenc(parent,tipoC,icCompeticiones);
