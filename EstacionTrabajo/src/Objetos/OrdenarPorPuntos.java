...
public class OrdenarPorPuntos implements IOrdenarLiga{
    ...
    public void  ordenar(Map<Integer,InfoEquipoCampeonato> lista,int []tabla,List<Integer> igualados){
        ...
        for(int g=0;g<iguales;g++){ 
            ...
            int punPrev=((InfoEquipoLiga)lista.get(tabla[inicio])).getPuntos();
            for (int i=inicio+1;i<=fin;i++){
                  int pun= ((InfoEquipoLiga)lista.get(tabla[i])).getPuntos(); 
