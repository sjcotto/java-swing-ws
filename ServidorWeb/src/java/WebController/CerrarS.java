...
public class CerrarS extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        objSesion.setAttribute("recargar","2");

        WebServices.UsuarioWS.UsuarioWS usuProxy = (WebServices.UsuarioWS.UsuarioWS)objSesion.getAttribute("ControladorUsuario");
        try{
            usuProxy.cerrarSesion(objSesion.getId());
