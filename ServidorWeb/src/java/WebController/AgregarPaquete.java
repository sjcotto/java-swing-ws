...
public class AgregarPaquete extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try { 
            icUsu.confirmarPaqueteApuestas(session.getId());
            
            session.setAttribute("recargar", "2");
            

            DataUsuario dataU = icUsu.obtenerUsuarioLogueado(session.getId());
            session.setAttribute("usuario",dataU);
